...
class ItemRepositoryTest {
    ...
    void findAll() {
        ...
        Item item2 = new Item("itemB", 20000, 23);
    ...
    void updateItem() {
        ...
        //when
        Item updateParam = new Item("itemC", 10000, 15);
        itemRepository.update(itemId, updateParam);

        Item findItem = itemRepository.findById(itemId);

        //then
        assertThat(findItem.getItemName()).isEqualTo("itemC");
        assertThat(findItem.getPrice()).isEqualTo(10000);
        assertThat(findItem.getQuantity()).isEqualTo(15);
    }
}